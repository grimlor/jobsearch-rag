...
class TestCompensationScoring:
    ...
    def test_comp_max_at_base_salary_scores_one(self) -> None:
        ...
        score = compute_comp_score(comp_max=220_000, base_salary=self.BASE, default_score=0.5)
    ...
    def test_comp_max_above_base_salary_scores_one(self) -> None:
        ...
        score = compute_comp_score(comp_max=300_000, base_salary=self.BASE, default_score=0.5)
    ...
    def test_comp_max_at_95_percent_of_base_scores_between_07_and_09(self) -> None:
        ...
        score = compute_comp_score(comp_max=209_000, base_salary=self.BASE, default_score=0.5)
    ...
    def test_comp_max_at_90_percent_of_base_scores_07(self) -> None:
        ...
        # When: score is computed
        score = compute_comp_score(comp_max=198_000, base_salary=self.BASE, default_score=0.5)
    ...
    def test_comp_max_at_85_percent_of_base_scores_between_04_and_07(self) -> None:
        ...
        # When: score is computed
        score = compute_comp_score(comp_max=187_000, base_salary=self.BASE, default_score=0.5)
    ...
    def test_comp_max_at_77_percent_of_base_scores_04(self) -> None:
        ...
        # When: score is computed
        score = compute_comp_score(comp_max=169_400, base_salary=self.BASE, default_score=0.5)
    ...
    def test_comp_max_at_72_percent_of_base_scores_between_00_and_04(self) -> None:
        ...
        # When: score is computed
        score = compute_comp_score(comp_max=158_400, base_salary=self.BASE, default_score=0.5)
    ...
    def test_comp_max_at_68_percent_of_base_scores_zero(self) -> None:
        ...
        # When: score is computed
        score = compute_comp_score(comp_max=149_600, base_salary=self.BASE, default_score=0.5)
    ...
    def test_comp_max_below_68_percent_of_base_scores_zero(self) -> None:
        ...
        score = compute_comp_score(comp_max=100_000, base_salary=self.BASE, default_score=0.5)
    ...
    def test_missing_comp_data_scores_05(self) -> None:
        ...
        score = compute_comp_score(comp_max=None, base_salary=self.BASE, default_score=0.5)
    ...
    def test_base_salary_is_read_from_config_not_hardcoded(self) -> None:
        ...
        score_at_base = compute_comp_score(
            comp_max=200_000, base_salary=200_000, default_score=0.5
        )
        score_below_base = compute_comp_score(
            comp_max=200_000, base_salary=300_000, default_score=0.5
        )
    ...
    def test_changing_base_salary_shifts_all_boundaries(self) -> None:
        ...
        score_100k = compute_comp_score(comp_max=90_000, base_salary=100_000, default_score=0.5)
        score_300k = compute_comp_score(comp_max=270_000, base_salary=300_000, default_score=0.5)
    ...
    def test_comp_score_is_always_between_zero_and_one(self) -> None:
        ...
        for label, comp_max in test_cases:
            ...
            score = compute_comp_score(comp_max=comp_max, base_salary=self.BASE, default_score=0.5)
    ...
    def test_comp_score_interpolates_linearly_within_bands(self) -> None:
        ...
        low = compute_comp_score(
            comp_max=170_000, base_salary=self.BASE, default_score=0.5
        )  # ~77%
        mid = compute_comp_score(
            comp_max=184_000, base_salary=self.BASE, default_score=0.5
        )  # ~83.6%
        high = compute_comp_score(
            comp_max=197_000, base_salary=self.BASE, default_score=0.5
        )  # ~89.5%
    ...
    def test_scale_is_continuous_across_band_boundaries(self) -> None:
        ...
        below_68 = compute_comp_score(
            comp_max=self.BASE * 0.68 - epsilon, base_salary=self.BASE, default_score=0.5
        )
        at_68 = compute_comp_score(
            comp_max=self.BASE * 0.68, base_salary=self.BASE, default_score=0.5
        )
        above_68 = compute_comp_score(
            comp_max=self.BASE * 0.68 + epsilon, base_salary=self.BASE, default_score=0.5
        )
        ...
        just_below_77 = compute_comp_score(
            comp_max=self.BASE * 0.77 - epsilon, base_salary=self.BASE, default_score=0.5
        )
        ...
        just_below_90 = compute_comp_score(
            comp_max=self.BASE * 0.90 - epsilon, base_salary=self.BASE, default_score=0.5
        )
        ...
        just_below_100 = compute_comp_score(
            comp_max=self.BASE - epsilon, base_salary=self.BASE, default_score=0.5
        )
        at_100 = compute_comp_score(comp_max=self.BASE, base_salary=self.BASE, default_score=0.5)
