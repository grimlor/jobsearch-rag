...
class TestChromaDBContract:
    ...
    async def test_persistence_survives_client_restart(self, embedder: Embedder) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            store1 = VectorStore(persist_dir=tmpdir, distance_metric="cosine", sync_threshold=10)
            ...
            store2 = VectorStore(persist_dir=tmpdir, distance_metric="cosine", sync_threshold=10)
...
def _make_live_settings(tmp_path: Path, *, max_pages: int = 1) -> Settings:
    ...
    return dataclasses.replace(
        ...
        chroma=ChromaConfig(persist_dir=chroma_dir, distance_metric="cosine", sync_threshold=10),
        output=OutputConfig(
