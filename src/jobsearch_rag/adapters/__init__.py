...
from jobsearch_rag.adapters import (
    indeed as _indeed,  # noqa: F401  # side-effect: triggers @register
    linkedin as _linkedin,  # noqa: F401  # side-effect: triggers @register
    weworkremotely as _wwr,  # noqa: F401  # side-effect: triggers @register
    ziprecruiter as _zr,  # noqa: F401  # side-effect: triggers @register
)
